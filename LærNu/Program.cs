...
PS.AddCourse(smurf);
//OUTPUT:
//Course: 'How to become a Smurf' has been added to user: Pia Stanø's courses...
//Student: 'Pia Stanø' has been added to the course: 'How to become a Smurf'...
PS.AddCourse(smurf);
//OUTPUT:
//Course: 'How to become a Smurf' is already among user: Pia Stanø's courses...
smurf.AddStudent(PS);
//OUTPUT:
...
PS.AddCourse(voice);
//OUTPUT:
//Course: 'Learn to listen: Turn off your ears' has been added to user: Pia Stanø's courses...
//Student: 'Pia Stanø' has been added to the course: 'Learn to listen: Turn off your ears'...
PS.RemoveCourse(voice);
//OUTPUT:
//Course: 'Learn to listen: Turn off your ears' has been removed from user: Pia Stanø's courses...
//Student: 'Pia Stanø' has been removed from the course: 'Learn to listen: Turn off your ears'...
PS.RemoveCourse(voice);
//OUTPUT:
//Course: 'Learn to listen: Turn off your ears' is not among user: Pia Stanø's courses...
...
MI.AddCourse(hy);
//OUTPUT:
//Course: 'Hygiene Part 1: How to Shower' has been added to user: Malte Iversen's courses...
...
MI.AddOwned(gi);
//OUTPUT:
//Course: 'How I Became the World's Smallest Giant' has been added to teacher: Malte Iversen's courses...
//Teacher: 'Malte Iversen' has been added to the course: 'How I Became the World's Smallest Giant'...
